...
orm.store_config(diffusion_path.ConditionalOptimalTransport, group=f'{Conf.model.key}/{models.FlowMatching.guidance.key}/{models.FlowMatching.diffusion_path.key}', name=f'_{diffusion_path.ConditionalOptimalTransport.__name__}')
...
orm.store_config(diffusion_path.ConditionalOptimalTransport, group=f'{Conf.model.key}/{models.FlowMatching.diffusion_path.key}', name=f'_{diffusion_path.ConditionalOptimalTransport.__name__}')
